            ...
            <div class="container relative flex flex-wrap items-center justify-between h-24 mx-auto overflow-hidden font-medium border-b border-gray-200 md:overflow-visible lg:justify-center sm:px-4 md:px-2">
                <div class="flex items-center justify-start w-1/4 h-full pr-4">
                    <a href="#_" class="inline-block py-4 md:py-0">
                        <NuxtLink to="/"><span class="p-1 text-xl font-black leading-none text-gray-900"><span class="text-white">catto</span><span class="primary-orange">css</span></span></NuxtLink>
                    </a>
                </div>
                <div class="top-0 left-0 items-start hidden w-full h-full p-4 text-sm bg-gray-900 bg-opacity-50 md:items-center md:w-3/4 md:absolute lg:text-base md:bg-transparent md:p-0 md:relative md:flex">
                    <div class="flex-col w-full h-auto overflow-hidden bg-white rounded-lg md:bg-transparent md:overflow-visible md:rounded-none md:relative md:flex md:flex-row">
                        ...
                        <div class="flex flex-col items-start justify-center w-full space-x-6 text-center lg:space-x-8 md:w-2/3 md:mt-0 md:flex-row md:items-center">
                            <a href="#_" class="inline-block w-full py-2 mx-0 ml-6 font-medium text-left primary-orange md:ml-0 md:w-auto md:px-0 md:mx-2 lg:mx-3 md:text-center"><NuxtLink to="/">Home</NuxtLink></a>
                            <a href="#_" class="inline-block w-full py-2 mx-0 font-medium text-left md:w-auto md:px-0 md:mx-2 hover:primary-orange lg:mx-3 md:text-center text-white"><NuxtLink to="/animations">Animations</NuxtLink></a>
                            <a href="#_" class="inline-block w-full py-2 mx-0 font-medium text-left md:w-auto md:px-0 md:mx-2 hover:primary-orange lg:mx-3 md:text-center text-white"><NuxtLink to="/about">About</NuxtLink></a>
